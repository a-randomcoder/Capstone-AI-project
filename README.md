...
**Note:** `bash scripts/bootstrap_integration.sh` migrates any legacy root / `Capstone-AI-Project/` paths into this layout and regenerates anemia + thyroid artifacts if missing.
